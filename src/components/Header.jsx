...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between">
      <div className="p-2 inline-block ml-5">
        <img
      ...
      {user && (
        <div className="flex items-center mt-2 md:mt-0">
          <img
            className="w-8 h-10 mr-2 rounded-xl"
          ...
          <button
            ...
            className="mr-5 text-sm bg-red-500 hover:bg-red-600 h-8 px-4 rounded-xl font-bold cursor-pointer"
          >
            Signout
          </button>
        </div>
